...
var Breaks = require('clean-css/lib/options/format').Breaks;
var Spaces = require('clean-css/lib/options/format').Spaces;

var Marker = require('clean-css/lib/tokenizer/marker');
var Token = require('clean-css/lib/tokenizer/token');
